...
x <- data.frame(
    symptoms=c(rep("Age", 1), 
             ...
             rep("COVID group: COVID + long***", 1) ,
             rep("COVID group: COVID + short***", 1) ,
             rep("COVID tested: Self-diagnosed +***", 1) ,
             rep("COVID tested: Tested  +**", 1) ,
             rep("Nb shots: 2 shots",  1) ,
...
geom_rect(aes(xmin = 0, xmax = 5,
  ...
  geom_point(aes(colour = Variables, shape = symptoms), size = 5 ) +
...
# save the plot
ggsave(filename="Figure2.jpeg", width = 30,  height = 30, units = "cm",dpi = 300)
